...
(function () {
  ...
  Frame = (function () {
    ...
    unmarshallSingle = function (data) {
      let body, chr, command, divider, headerLines, headers, i, idx, len, line,
  ...
  Client = (function () {
    ...
    Client.prototype.connect = function () {
      ...
      this.ws.onmessage = function (evt) {
        let arr, c, client, data, frame, messageID, onreceive, subscription, _i,
            _len, _ref, _results;
  ...
  Stomp = {
    ...
    client: function (url, protocols) {
      ...
      theClass = Stomp.WebSocketClass || WebSocket;
      ws = new theClass(url, protocols);
